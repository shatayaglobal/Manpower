...
function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1.5 text-base font-semibold px-2.5 py-1 rounded-full border",
        s.color
      )}
    >
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-2xl border border-amber-100 p-5">
            <p className="text-base font-semibold text-amber-500 uppercase tracking-wide mb-1">
              Needs Signature
            </p>
          ...
          {pageLoading ? (
            ...
            <>
              ...
              <div className="hidden md:grid grid-cols-[1fr_1.5fr_1fr_1.5fr_auto] gap-4 px-5 py-3 border-b border-gray-50 bg-gray-50/60">
                ...
                <p className="text-base font-semibold text-gray-400 uppercase tracking-wide text-right">
                  Action
                </p>
              </div>
                    ...
                    <div className="flex justify-end">
                      {canSign(card) ? (
                        <Button
                          ...
                          className="bg-blue-600 hover:bg-blue-700 text-white h-8 px-3 text-base font-semibold"
                        >
                        ...
                        <Button
                          ...
                          className="border-gray-200 text-gray-600 hover:border-blue-200 hover:text-blue-600 h-8 px-3 text-base"
                        >
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 rounded-xl p-4 space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-base text-gray-500">Clock In</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-base text-gray-500">Clock Out</span>
                  <span className="text-sm font-medium text-gray-900">
                    {getTime(
              ...
              {detailsCard.is_signed && (
                <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                  ...
                  {detailsCard.worker_signed_at && (
                    <p className="text-base text-blue-500 mt-0.5">
              ...
              {detailsCard.status === "REJECTED" &&
                detailsCard.rejection_reason && (
                  <div className="bg-red-50 border border-red-100 rounded-xl p-4">
                    <p className="text-base font-semibold text-red-700 mb-1 flex items-center gap-1.5">
