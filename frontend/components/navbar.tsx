          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4 text-center sm:text-left">
              <div className="flex items-center space-x-3 justify-center sm:justify-start">
                ...
                <span className="font-semibold text-lg text-gray-900">Shataya Global</span>
              </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                <li>
                  <a href="mailto:Shatayaglobal@gmail.com" className="hover:text-blue-600 transition-colors">
                    Shatayaglobal@gmail.com
                  </a>
                </li>
                <li>
                  <a href="tel:+972546126874" className="hover:text-blue-600 transition-colors">
                    +972 546126874
                  </a>
                </li>
              </ul>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 text-gray-600 text-sm">
                ...
                <li><Link href="/post-job" className="hover:text-blue-600 transition-colors">Post a Job</Link></li>
