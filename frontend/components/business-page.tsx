  ...
  return (
    ...
    >
      ...
      {badge !== undefined && badge > 0 && (
        <span className="min-w-[20px] h-5 px-1.5 bg-red-500 text-white text-base font-bold rounded-full flex items-center justify-center shrink-0">
          {badge}
        </span>
      )}
...
function BusinessModal({ business, onClose }: ModalProps) {
  ...
  const inputCls = (err?: string) =>
    cn(
      "w-full px-3 py-2.5 border rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
      err ? "border-red-300 bg-red-50" : "border-gray-200"
    );
  const selectCls =
    "w-full px-3 py-2.5 border border-gray-200 rounded-xl text-base focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white";
  const labelCls = "block text-base font-semibold text-gray-500 mb-1.5";
  ...
  return (
    <div className="bg-gray-50 -ml-4 -mt-5 min-h-screen -mr-4">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-5">
        ...
        {/* ── Needs-action alert ── */}
        {(pendingApproval > 0 || pendingApps > 0) && (
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            title="Active Shifts"
            value={business.total_shifts ?? 0}
            icon={Calendar}
            border="border-violet-100"
          />
          <StatCard
            title="Hours This Week"
            value={`${business.total_hours_this_week ?? 0}h`}
            icon={TrendingUp}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            <div>
              <p className="text-base font-bold uppercase text-amber-500 mb-1">
                Hours Approval
              </p>
              <p
                className={cn(
            ...
            {pendingApproval > 0 ? (
              ...
              <p className="text-base text-emerald-600 font-semibold mt-3 flex items-center gap-1">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="space-y-2">
              ...
              <QuickAction
                ...
                color="bg-rose-500"
                title="Approve Hours"
                subtitle="Sign off on hour cards"
