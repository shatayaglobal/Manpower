...
export default function SignUpPage() {
  ...
  const handleCredentialResponse = async (response: GoogleCredentialResponse) => {
    try {
      ...
      if (result.success) {
        toast.success("Google sign-up successful! Welcome to your Worker account.");
    ...
    if (window.google) {
      try {
        ...
        try {
          ...
          toast.error("Unable to open Google Sign-Up. Please try again.");
        }
      }
    } else {
      toast.error("Google Sign-Up is not available. Please try again later.");
    }
  };
